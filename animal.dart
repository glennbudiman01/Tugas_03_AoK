...
Future<List<AnimalEntity>> _fetchAnimals() async {
  String jsonString = await rootBundle.loadString('assets/data/animals.json');
...
class _AnimalScreenState extends State<AnimalScreen> {
  Future<List<AnimalEntity>> _animalsFuture;
